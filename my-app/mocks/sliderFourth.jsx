...
export const sliderDatas =[
    {id:'1', src:mainSlider1, title:"Wirhe Mesh", text:'Economical and durable, welded wire mesh is manufactured on state-of-the-art, automated, grid welding equipment. Line and cross wires lay flat at each intersection and are resistance welded for maximum cross-sectional strength. Recently, earthquakes have been inevitable. For this reason, the demand for quality construction materials has increased. Our company is always ready to provide you with high-quality fittings that are resistant to moisture, heat, and corrosion.' , alt:'image1', status:false },
    {id:'2', src:mainSlider2, title:"Steel Rebar", text:'Rebars are concrete structures reinforced with iron bars to increase the strength of concrete in construction. These rebars help to make buildings and other constructions long-term stable by giving structures higher resistance to impact, pressure and bending forces.' , alt:'image2', status:false },
    {id:'3', src:mainSlider3, title:"I-Beams", text:'I-beam metals are specially shaped pieces of iron or steel widely used in construction, renovation, and other industrial fields. The shape of these beams provides them with high structural strength, making them an ideal choice for many construction projects.' , alt:'image3', status:false },
    {id:'4', src:mainSlider4, title:"Galvanized Steel Coil", text:'Galvanized sheet is a sheet coated with zinc to increase the corrosion resistance of the metal. This coating protects the iron against corrosion caused by contact with air and water, extending the life of the sheet.' , alt:'image3', status:false },
    {id:'5', src:mainSlider5, title:"Pipes Steel", text:'Economical and durable, welded wire mesh is manufactured on state-of-the-art, automated, grid welding equipment. Line and cross wires lay flat at each intersection and are resistance welded for maximum cross-sectional strength. Recently, earthquakes have been inevitable. For this reason, the demand for quality construction materials has increased. Our company is always ready to provide you with high-quality fittings that are resistant to moisture, heat, and corrosion.' , alt:'image3', status:false },
    {id:'6', src:mainSlider6, title:"Steel Wire Rod", text:'"Steel wire rod", also known as iron rod, has a wide range of applications. Made from an iron-carbon blend, they boast high durability. They are used in electrode manufacturing, roping, and many other industrial areas.' , alt:'image3', status:false },
    {id:'7', src:mainSlider7, title:"Steel Profile Pipe", text:'Economical and durable, welded wire mesh is manufactured on state-of-the-art, automated, grid welding equipment. Line and cross wires lay flat at each intersection and are resistance welded for maximum cross-sectional strength. Recently, earthquakes have been inevitable. For this reason, the demand for quality construction materials has increased. Our company is always ready to provide you with high-quality fittings that are resistant to moisture, heat, and corrosion.' , alt:'image3', status:false },
    {id:'8', src:mainSlider8, title:"Channel", text:'Channel on the other hand, is a U-shaped piece of metal, commonly utilized in load-bearing structures, bridges, and other similar constructions.' , alt:'image3', status:false },
    {id:'9', src:mainSlider9, title:"Steel Sheet", text:'Steel Sheet has a broad range of applications and is used in various constructions, machinery building, and other industrial fields. These sheets are characterized by their resistance to corrosion and durability.' , alt:'image3', status:false },
]


export const Materials = [
    {id:1,src:materials1,alt:'info1'},
    {id:2,src:materials2,alt:'info2'},
    {id:3,src:materials3,alt:'info3'},
    {id:4,src:materials4,alt:'info3'},
    {id:5,src:materials5,alt:'info3'},
    {id:6,src:materials6,alt:'info3'},
    {id:7,src:materials7,alt:'info3'},
