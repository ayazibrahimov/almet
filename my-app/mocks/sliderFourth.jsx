...
import mainSlider10 from "@/public/mainSlider10.jpg";
...
import materialsAdd3 from "@/public/materialsAdd3.jpg";
...
import materials10 from "@/public/materials10.jpg";
...
export const sliderDatas =[
    ...
    {id:'2', src:mainSlider2, title:"Steel wire rod", text:'"Steel wire rod", also known as iron rod, has a wide range of applications. Made from an iron-carbon blend, they boast high durability. They are used in electrode manufacturing, roping, and many other industrial areas.' , alt:'image2', status:false },
    ...
    {id:'5', src:mainSlider5, title:"PVC coated wire", text:'Garden and Park Fences: Garden fences, park fences and green area boundaries are often preferred. Agricultural Areas: Can be used to define land boundaries and protect crops in agricultural areas. Private Properties: Used to define land boundaries in houses with attached and private properties.' , alt:'image3', status:false },
...
export const sliderDatas2=[
    ...
    {id:'5', src:mainSlider7, title:"Steel Profile Pipe", text:'Economical and durable, welded wire mesh is manufactured on state-of-the-art, automated, grid welding equipment. Line and cross wires lay flat at each intersection and are resistance welded for maximum cross-sectional strength. Recently, earthquakes have been inevitable. For this reason, the demand for quality construction materials has increased. Our company is always ready to provide you with high-quality fittings that are resistant to moisture, heat, and corrosion.' , alt:'image3', status:false },
    {id:'6', src:mainSlider8, title:"Channel", text:'Channel on the other hand, is a U-shaped piece of metal, commonly utilized in load-bearing structures, bridges, and other similar constructions.' , alt:'image3', status:false },
    {id:'7', src:mainSlider9, title:"Steel Sheet", text:'Steel Sheet has a broad range of applications and is used in various constructions, machinery building, and other industrial fields. These sheets are characterized by their resistance to corrosion and durability.' , alt:'image3', status:false },
...
export const Materials2=[
    ...
    {id:2,src:materials10,alt:'info3'},
    {id:3,src:materialsAdd6,alt:'info3'},
    {id:4,src:materials5,alt:'info3'},
    {id:5,src:materials7,alt:'info3'},
    {id:6,src:materials8,alt:'info3'},
    {id:7,src:materials9,alt:'info3'},
]
